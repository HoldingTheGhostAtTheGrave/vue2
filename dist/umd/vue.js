(function (global, factory) {
  ...
  strats.components = function (parentVal, childVal) {
    var res = Object.create(parentVal); // res.__prop__ = parentVal；
    if (childVal) {
  ...
  function renderMinin(Vue) {
    ...
    Vue.prototype._c = function () {
      return createElement.apply(void 0, [this].concat(Array.prototype.slice.call(arguments))); // 虚拟节点
    };
    // 如果是对象会对对象进行取值
  ...
  function createComponent(vm, tag, data, key, children, Ctor) {
    var barseCtor = vm.$options._base;
    // 有可能是对象 也有可能是 函数
